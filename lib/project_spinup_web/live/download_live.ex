              ...
              >
                <span class="shrink-0 text-green-600">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="w-8 h-8">
                    ...
                    <path fill="#0c7238" d="M6,42H26c1.105,0,2-0.895,2-2V28H4v12C4,41.105,4.895,42,6,42z"/>
                    <path fill="#fff" d="M9.962,37l-1.977-3.754L5.995,37H4l2.985-4.56L4.085,28h1.995l1.93,3.695L9.934,28h1.992l-2.947,4.352L12,37H9.962z"/>
                  </svg>
                </span>
